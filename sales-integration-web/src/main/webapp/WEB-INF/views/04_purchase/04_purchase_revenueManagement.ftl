<#import "../layout/sidebar_purchase.ftl" as page>
...
<@page.base pageTitle>
    ...
    <div class="container_r">    
		...
		<form action="revenueConfirm.purchase" method="post" id="frm_m">
			...
			<div class="btn_box"><a href="#" class="btn_sm_sch_black r3" onClick="document.getElementById('frm_m').submit();">조회</a></div><!-- class="btn_sch_black r3" -->
			</form>
		</div>
		<!-- //조회 --> 
